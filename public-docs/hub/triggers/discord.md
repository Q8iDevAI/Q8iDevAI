...
`.q8idevai/workflows/discord-help.yml`:
...
Leading declared inputs follow the mention. Hub exposes the remaining text as `${{ q8idevai.prompt }}`. See [Workflows](/docs/hub/workflows).
