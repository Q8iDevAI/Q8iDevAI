...
A daemon runs agents on one machine, for you. Q8iDevAI Hub is the layer above your daemons. You register your daemons with it, and it gives them capabilities they do not have on their own.
...
`q8idevai hub init` creates one self-contained starter trigger:
...
[Hosted Hub](/docs/hub/hosted) uses the same triggers, daemons, and activity model. [Sign in to start a free trial](https://hub.q8idevai.sh).
