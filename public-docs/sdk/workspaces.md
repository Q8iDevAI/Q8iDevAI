...
description: Open directories as Q8iDevAI workspaces, place agents in them, follow changes, and archive them.
nav: Workspaces
order: 53
...
Use a workspace when an integration needs a durable place in the Q8iDevAI app for agents, terminals, browsers, and files related to one task.
...
Create a Q8iDevAI-owned worktree when concurrent work needs an isolated checkout:
