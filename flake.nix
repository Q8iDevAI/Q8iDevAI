  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        let
          pkgs = pkgsFor system;
          q8idevai = pkgs.callPackage ./nix/package.nix { };
          versionParts = pkgs.lib.splitString "." q8idevai.version;
      ...
      nixosModules.default = self.nixosModules.q8idevai;
      nixosModules.q8idevai =
        { pkgs, lib, ... }:
        {
          imports = [ ./nix/module.nix ];
          services.q8idevai.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.default;
        };
