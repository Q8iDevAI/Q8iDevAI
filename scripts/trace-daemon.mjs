...
// Used by nix/package.nix's installPhase to materialize $out/lib/q8idevai
...
// installPhase copies each path to $out/lib/q8idevai/<path>, preserving the
...
const traceDesktop = process.env.Q8IDEVAI_TRACE_DESKTOP === "1";
