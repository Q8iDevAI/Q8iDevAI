...
import { readDaemonInstance } from "@q8idevai/server";
  ...
  const metro = spawn(
    ...
    ],
    {
      ...
      env: {
        ...
        EXPO_NO_DOTENV: "1",
        CI: "1",
        Q8IDEVAI_WEB_PLATFORM: "electron",
  ...
  try {
    ...
    desktop = await electron.launch({
      ...
      env: {
        ...
        Q8IDEVAI_DISABLE_SINGLE_INSTANCE_LOCK: "1",
        Q8IDEVAI_ELECTRON_USER_DATA_DIR: path.join(root, "renderer-user-data"),
      },
    });
