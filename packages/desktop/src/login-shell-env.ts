...
const TIMEOUT_ENV_KEY = "Q8IDEVAI_SHELL_ENV_TIMEOUT_MS";
...
function resolveShellEnv({ deps, timeoutMs }: ResolveShellEnvInput): ResolvedShellEnv {
  ...
  delete shellEnv.Q8IDEVAI_NODE_ENV;
  delete shellEnv.Q8IDEVAI_DESKTOP_MANAGED;
  delete shellEnv.Q8IDEVAI_SUPERVISED;
