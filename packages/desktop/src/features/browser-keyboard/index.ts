...
import { Q8iDevAIBrowserWebviewRegistry } from "../browser-webviews/registry.js";
import {
...
const POLICY_INPUT_CHANNEL = "q8idevai:browser:set-shortcut-policy";
const POLICY_OUTPUT_CHANNEL = "q8idevai:browser-keyboard-policy";
const POLICY_REQUEST_CHANNEL = "q8idevai:browser-keyboard-policy-request";
const SHORTCUT_INPUT_CHANNEL = "q8idevai:browser-shortcut-input";
const SHORTCUT_OUTPUT_CHANNEL = "q8idevai:event:browser-shortcut-input";
const RESERVED_SHORTCUT_OUTPUT_CHANNEL = "q8idevai:event:browser-shortcut";
...
export class BrowserKeyboard {
  ...
  public constructor(private readonly browserRegistry: Q8iDevAIBrowserWebviewRegistry) {}
