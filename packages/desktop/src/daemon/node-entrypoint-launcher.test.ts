...
describe("node-entrypoint-launcher", () => {
  describe("createNodeEntrypointInvocation", () => {
    it("uses the packaged runner when the desktop app is packaged", () => {
      expect(
        createNodeEntrypointInvocation({
          execPath: "/Applications/Q8iDevAI.app/Contents/MacOS/Q8iDevAI",
          isPackaged: true,
          packagedRunnerPath:
            "/Applications/Q8iDevAI.app/Contents/Resources/app.asar/dist/daemon/node-entrypoint-runner.js",
        ...
        command: "/Applications/Q8iDevAI.app/Contents/MacOS/Q8iDevAI",
        args: [
    ...
    it("uses the entrypoint directly in development", () => {
      expect(
        createNodeEntrypointInvocation({
          ...
          argvMode: "node-script",
          args: ["ls"],
          baseEnv: { PATH: "/usr/bin", Q8IDEVAI_NODE_ENV: "production" },
        }),
      ).toEqual({
        command: "/opt/homebrew/bin/electron",
        args: ["--import", "tsx", "/tmp/q8idevai-cli.js", "ls"],
        env: {
          PATH: "/usr/bin",
          ELECTRON_RUN_AS_NODE: "1",
