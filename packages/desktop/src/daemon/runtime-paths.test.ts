...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      ...
      resourcesPath: "/Applications/Q8iDevAI.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/Q8iDevAI.app/Contents/Frameworks/Q8iDevAI Helper.app/Contents/MacOS/Q8iDevAI Helper",
    );
  });
});
