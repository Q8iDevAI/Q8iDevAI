export const meta = {
  name: "q8idevai-project-inspection",
  description: "Inspect Q8iDevAI and explain what the project does",
  whenToUse: "Q8iDevAI real-provider workflow detail QA",
...
const report = await agent(
  `Inspect the Q8iDevAI repository at ${JSON.stringify(repoPath)}.
