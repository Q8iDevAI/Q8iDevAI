export const meta = {
  name: "q8idevai-workflow-row-qa",
  description: "Verify the workflow row lifecycle",
  whenToUse: "Q8iDevAI real-provider QA only",
...
Then return exactly this JSON object and do nothing else: {"marker":"Q8IDEVAI_WORKFLOW_ROW_OK"}`,
  {
