...
const GROUPED_PROJECT_NAME = "q8idevai-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/q8idevai-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.q8idevaiHome, "projects", "projects.json");
