...
const GITHUB_ISSUE_DESTINATION =
  /^https:\/\/github\.com\/(?:getq8idevai\/q8idevai\/issues\/new(?:\/choose)?(?:[/?#]|$)|login\?return_to=https%3A%2F%2Fgithub\.com%2Fgetq8idevai%2Fq8idevai%2Fissues%2Fnew$)/;
const CHANGELOG_DESTINATION = /^https:\/\/q8idevai\.sh\/changelog(?:[/?#]|$)/;
...
const APP_VERSION = /^Q8iDevAI\s*v\d+\.\d+\.\d+(?:-[0-9A-Za-z.-]+)?(?:\+[0-9A-Za-z.-]+)?$/;
