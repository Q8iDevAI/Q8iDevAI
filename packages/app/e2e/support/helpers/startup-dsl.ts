...
const DISABLE_DEFAULT_SEED_ONCE_KEY = "@q8idevai:e2e-disable-default-seed-once";
const SEED_NONCE_KEY = "@q8idevai:e2e-seed-nonce";
const REGISTRY_KEY = "@q8idevai:daemon-registry";
const E2E_KEY = "@q8idevai:e2e";
  ...
  private async prepare(): Promise<void> {
    ...
    await this.page.evaluate(
      ({ keys, registry: storedRegistry, createAgentPreferences: storedPreferences }) => {
        ...
        localStorage.setItem("@q8idevai:create-agent-preferences", JSON.stringify(storedPreferences));
