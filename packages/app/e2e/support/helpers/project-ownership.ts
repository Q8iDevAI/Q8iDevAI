...
interface ProjectClient {
  ...
  close(): Promise<void>;
  createQ8iDevAIWorktree?: (...args: unknown[]) => Promise<OwnedResourceResult>;
...
export function withProjectOwnership<Client extends object>(client: Client): Client {
  ...
  return new Proxy(client, {
    get(_target, property) {
      ...
      if (property === "createQ8iDevAIWorktree" && target.createQ8iDevAIWorktree) {
        const createQ8iDevAIWorktree = target.createQ8iDevAIWorktree.bind(target);
        return async (...args: unknown[]) => trackProject(await createQ8iDevAIWorktree(...args));
      }
