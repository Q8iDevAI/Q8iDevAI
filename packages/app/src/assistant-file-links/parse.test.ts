...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.q8idevai/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.q8idevai/plans/file-preview.md",
      path: "~/.q8idevai/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.q8idevai/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.q8idevai/plans/file-preview.md:12",
      path: "~/.q8idevai/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.q8idevai/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.q8idevai/plans",
      file: "~/.q8idevai/plans/file-preview.md",
    });
  });
