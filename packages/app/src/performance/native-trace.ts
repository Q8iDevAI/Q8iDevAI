import type { DaemonClientTrace } from "@q8idevai/client/internal/daemon-client";
import { requireOptionalNativeModule } from "expo-modules-core";
import { isProfileBuild } from "@/constants/build-profile";

interface Q8iDevAINativeTraceModule {
  beginSection(name: string): void;
  endSection(): void;
}

const traceModule = requireOptionalNativeModule<Q8iDevAINativeTraceModule>("Q8iDevAINativeTrace");
