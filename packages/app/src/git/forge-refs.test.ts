...
describe("parseForgeRef", () => {
  it.each([
    [
      "GitHub pull request",
      "git@github.com:getq8idevai/q8idevai.git",
      "https://github.com/Q8iDevAI/Q8iDevAI/pull/994/files?diff=split#discussion_r123",
      { kind: "change_request", number: 994 },
    ],
    [
      "GitHub issue",
      "https://github.com/Q8iDevAI/Q8iDevAI.git",
      "https://github.com/Q8iDevAI/Q8iDevAI/issues/456",
  ...
  it("canonicalizes a cloud SSH alias to its web host", () => {
    expect(
      parseForgeRef(
        "https://github.com/Q8iDevAI/Q8iDevAI/pull/994",
        "ssh://git@ssh.github.com/Q8iDevAI/Q8iDevAI.git",
      ),
  ...
  it("does not apply another forge's route grammar to a known cloud host", () => {
    expect(
      parseForgeRef(
        "https://github.com/Q8iDevAI/Q8iDevAI/pulls/31",
        "git@github.com:getq8idevai/q8idevai.git",
      ),
    ).toBeNull();
    expect(
...
describe("extractForgeRefs", () => {
  ...
  it("returns no references without text or a valid remote", () => {
    expect(extractForgeRefs("", "git@github.com:getq8idevai/q8idevai.git")).toEqual([]);
    expect(extractForgeRefs("https://github.com/Q8iDevAI/Q8iDevAI/pull/1", null)).toEqual([]);
  });
});
