 ...
 * as before.
 */
import { FORGE_DEFINITIONS, getForgeDefinitionOrNeutral } from "@q8idevai/protocol/forge-manifest";
import { normalizeHost, parseGitRemoteLocation } from "@q8idevai/protocol/git-remote";
import type { ForgeAuthState } from "@q8idevai/protocol/messages";
import {
  buildForgeBlobUrl,
...
export interface ForgePresentation {
  ...
  /** Auth CLI binary for the install hint, or null for a forge with no Q8iDevAI-driven sign-in. */
