...
describe("shouldFetchTimelineFrom", () => {
  const baseGate = {
    ...
    githubFeaturesEnabled: true,
    cwd: "/repo",
    identity: { prNumber: 42, repoOwner: "getq8idevai", repoName: "q8idevai" },
...
describe("fetchPrPaneTimelinePage", () => {
  it("forwards the cwd, PR number, owner, and name to the daemon client", async () => {
    ...
    expect(client.calls).toEqual([
      { cwd: "/repo", prNumber: 42, repoOwner: "getq8idevai", repoName: "q8idevai" },
    ]);
  });
      ...
      items: [
        {
          ...
          body: "Looks good",
          createdAt: Date.now(),
          url: "https://github.com/Q8iDevAI/Q8iDevAI/pull/42#c1",
        },
      ],
    });
        ...
        items: [
          {
            ...
            createdAt: Date.now(),
            url: "https://github.com/Q8iDevAI/Q8iDevAI/pull/41#c1",
          },
        ],
      }),
    });
