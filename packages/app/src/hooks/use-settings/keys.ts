...
export const APP_SETTINGS_KEY = "@q8idevai:app-settings";
export const LEGACY_SETTINGS_KEY = "@q8idevai:settings";
 ...
 * a schema change.
 */
export const SETTINGS_MIGRATIONS_KEY = "@q8idevai:settings-migrations";
