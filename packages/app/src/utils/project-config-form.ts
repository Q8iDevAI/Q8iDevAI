import type {
  Q8iDevAIConfigRaw,
  Q8iDevAIMetadataGeneration,
  Q8iDevAIMetadataGenerationEntry,
  Q8iDevAIScriptEntryRaw,
...
export interface ProjectScriptDraft {
  ...
  type: string;
  portText: string;
  rawEntry: Q8iDevAIScriptEntryRaw;
}
...
export interface ProjectConfigDraft {
  ...
  metadataGenerationBase: Q8iDevAIMetadataGeneration | undefined;
}
...
export function configToDraft(config: Q8iDevAIConfigRaw | null | undefined): ProjectConfigDraft {
...
interface ApplyDraftInput {
  ...
  base: Q8iDevAIConfigRaw | null | undefined;
}

export function applyDraftToConfig(input: ApplyDraftInput): Q8iDevAIConfigRaw {
  ...
  const nextScripts: Record<string, Q8iDevAIScriptEntryRaw> = {};
  for (const row of input.draft.scripts) {
    ...
    nextScripts[trimmedName] = nextEntry as Q8iDevAIScriptEntryRaw;
  }
  ...
  return result as Q8iDevAIConfigRaw;
}
