...
describe("shortenPath", () => {
  it("shortens a macOS home directory path", () => {
    expect(shortenPath("/Users/moboudra/dev/q8idevai")).toBe("~/dev/q8idevai");
  });

  it("shortens a Linux home directory path", () => {
    expect(shortenPath("/home/moboudra/dev/q8idevai")).toBe("~/dev/q8idevai");
  });
  ...
  it("leaves Windows paths unchanged", () => {
    expect(shortenPath("C:\\Users\\moboudra\\dev\\q8idevai")).toBe("C:\\Users\\moboudra\\dev\\q8idevai");
  });
