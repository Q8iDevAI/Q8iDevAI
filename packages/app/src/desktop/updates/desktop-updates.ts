...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/Q8iDevAI/Q8iDevAI/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Q8iDevAI-${normalizedVersion}-arm64.dmg`;
}
