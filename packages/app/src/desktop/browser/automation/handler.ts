...
import type { SessionInboundMessage, SessionOutboundMessage } from "@q8idevai/protocol/messages";
...
export function mountBrowserAutomationDaemonClientHandler(
  client: import("@q8idevai/client/internal/daemon-client").DaemonClient,
