...
const RESIDENT_BROWSER_HOST_ID = "q8idevai-browser-resident-webviews";
const BROWSER_ID_ATTRIBUTE = "data-q8idevai-browser-id";
const BROWSER_SURFACE_ATTRIBUTE = "data-q8idevai-browser-surface";
