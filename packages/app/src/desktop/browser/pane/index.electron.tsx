...
function buildAnnotationMarkerScript(markers: readonly BrowserAnnotationMarker[]): string {
  ...
  return `
    (function() {
      var markers = ${payload};
      if (window.__q8idevaiAnnotationMarkers) { window.__q8idevaiAnnotationMarkers.update(markers); return true; }
      ...
      window.__q8idevaiAnnotationMarkers = {
        ...
        destroy: function() {
          ...
          window.__q8idevaiAnnotationMarkers = null;
        }
      };
      reposition();
      return true;
...
function clearAnnotationMarkers(webview: ElectronWebview): void {
  void executeWebviewJavaScript(
    webview,
    "if(window.__q8idevaiAnnotationMarkers) window.__q8idevaiAnnotationMarkers.destroy();",
