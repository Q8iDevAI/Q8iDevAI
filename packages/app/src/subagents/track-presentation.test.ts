...
import type { Q8iDevAISubagentRow, ProviderSubagentRow, SubagentRow } from "./select";
import {
...
function row(
  overrides: Partial<Q8iDevAISubagentRow> & Pick<Q8iDevAISubagentRow, "id">,
): Q8iDevAISubagentRow {
  return {
    kind: "q8idevai",
    id: overrides.id,
