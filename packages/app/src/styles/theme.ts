...
import { darkHighlightColors, lightHighlightColors } from "@q8idevai/highlight";
...
// Q8iDevAI — subtle teal-green tint (default)
const q8idevaiDarkColors = buildDarkSemanticColors({
  surface0: "#181B1A",
  surface1: "#1E2120",
  surface2: "#272A29",
  surface3: "#434645",
...
export const darkTheme = buildDarkTheme(q8idevaiDarkColors);
