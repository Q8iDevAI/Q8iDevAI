import type { OwnedSubscription } from "@q8idevai/client";
...
interface ServerDataPushClient {
  getProvidersSnapshot: import("@q8idevai/client/internal/daemon-client").DaemonClient["getProvidersSnapshot"];
  observeEvents: import("@q8idevai/client/internal/daemon-client").DaemonClient["observeEvents"];
  observeCheckoutDiff: import("@q8idevai/client/internal/daemon-client").DaemonClient["observeCheckoutDiff"];
  observeTerminals: import("@q8idevai/client/internal/daemon-client").DaemonClient["observeTerminals"];
}
