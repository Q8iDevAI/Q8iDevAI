...
const DOCS_URL = "https://q8idevai.sh/docs";
...
const WEB_SPLASH_SHIMMER_KEYFRAME_ID = "q8idevai-splash-shimmer-keyframes";
const WEB_SPLASH_SHIMMER_ANIMATION_NAME = "q8idevai-splash-shimmer";
  ...
  const maskElement = useMemo(
    () => (
      <View style={styles.shimmerMask}>
        <Q8iDevAILogo size={LOGO_SIZE} color="#000000" />
      </View>
    ),
    [],
  );
    ...
    <MaskedView style={trackStyle} maskElement={maskElement}>
      <View style={trackStyle}>
        <View style={styles.nativeShimmerBase}>
          <Q8iDevAILogo size={LOGO_SIZE} color={color} />
        </View>
