...
import { getOpenAgentTabLabel } from "@q8idevai/protocol/agent-labels";
import {
  memo,
  useCallback,
  useEffect,
...
export const WorkspaceScreen = memo(function WorkspaceScreen({
  ...
  useEffect(() => {
    traceInstant("q8idevai.workspace.mount", { serverId, workspaceId });
    return () => {
      traceInstant("q8idevai.workspace.unmount", { serverId, workspaceId });
    };
