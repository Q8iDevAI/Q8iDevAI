...
import type { AgentAttachment } from "@q8idevai/protocol/messages";
...
import type { AgentCapabilityFlags } from "@q8idevai/protocol/agent-types";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "q8idevai-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "q8idevai-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--q8idevai-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--q8idevai-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return inlineUnistylesStyle({
    ...
    "--q8idevai-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--q8idevai-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  });
}
