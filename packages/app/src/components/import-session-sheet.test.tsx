...
function renderSheet(
  ...
  const cwd = options && "cwd" in options ? (options.cwd ?? undefined) : "/repo/q8idevai";
...
describe("ImportSessionSheet", () => {
  ...
  it("lists unscoped rows newest first and names each row's folder", async () => {
    const fetchRecentProviderSessions = vi.fn(async () => ({
      ...
      entries: [
        createProviderSessionEntry({
          ...
          cwd: "/home/me/q8idevai",
          title: "Newest in q8idevai",
        ...
        createProviderSessionEntry({
          ...
          cwd: "/home/me/q8idevai",
          title: "Older in q8idevai",
          lastActivityAt: "2026-04-30T10:00:00.000Z",
        }),
        createProviderSessionEntry({
          providerId: "claude",
          providerHandleId: "worktree",
          cwd: "/home/me/q8idevai/.dev/worktrees/zebra",
    ...
    renderSheet(
      ...
      {
        cwd: null,
        projects: [{ iconWorkingDir: "/home/me/q8idevai", projectName: "q8idevai" }],
        snapshot: { supportsSnapshot: true, entries: [createSnapshotEntry("claude")] },
      },
    );
    ...
    ).toEqual(["q8idevai", "/tmp/scratch", "q8idevai", "q8idevai · .dev/worktrees/zebra"]);
  });
  ...
  it("leaves the folder off every row when the sheet is scoped to one workspace", async () => {
    ...
    renderSheet(
      ...
      {
        workspaceId: "ws-current",
        projects: [{ iconWorkingDir: "/repo/q8idevai", projectName: "q8idevai" }],
        snapshot: { supportsSnapshot: true, entries: [createSnapshotEntry("claude")] },
      },
    );
