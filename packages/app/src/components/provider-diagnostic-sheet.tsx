...
import { compareMatchScores, scoreTextFields } from "@q8idevai/protocol/search/text-match";
import type { AgentModelDefinition, AgentProvider } from "@q8idevai/protocol/agent-types";
import type { ProviderProfileModel } from "@q8idevai/protocol/provider-config";
import {
