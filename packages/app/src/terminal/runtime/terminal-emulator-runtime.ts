...
} from "@q8idevai/protocol/terminal-input-mode";
import {
...
export class TerminalEmulatorRuntime {
  ...
  mount(input: TerminalEmulatorRuntimeMountInput): void {
    ...
    window.__q8idevaiTerminal = terminal;
  ...
  unmount(): void {
    ...
    this.cleanup?.();
    this.cleanup = null;
    if (window.__q8idevaiTerminal === this.terminal) {
      window.__q8idevaiTerminal = undefined;
    }
    this.terminal = null;
    this.searchAddon = null;
    this.findQuery = "";
