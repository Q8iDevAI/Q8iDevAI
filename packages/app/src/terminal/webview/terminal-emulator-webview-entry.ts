...
import type { TerminalInputModeState } from "@q8idevai/protocol/terminal-input-mode";
...
declare global {
  interface Window {
    ...
    __Q8IDEVAI_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __Q8IDEVAI_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--q8idevai-terminal-background";
...
window.__Q8IDEVAI_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__Q8IDEVAI_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
