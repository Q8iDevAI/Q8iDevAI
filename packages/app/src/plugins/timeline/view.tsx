import { PluginClientStateProvider } from "@q8idevai/plugin/client/host";
import type { PluginHostProps, PluginTimelineItemProps } from "@q8idevai/plugin/client";
import type { PluginTheme } from "@q8idevai/plugin";
