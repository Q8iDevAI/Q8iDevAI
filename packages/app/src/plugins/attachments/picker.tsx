...
import type { PluginAttachmentItem, PluginAttachmentSourceContribution } from "@q8idevai/plugin";
import { searchPluginAttachments } from "@q8idevai/plugin/client/host";
