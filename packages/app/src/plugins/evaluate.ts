...
import * as pluginClientRuntime from "@q8idevai/plugin/client";
import * as React from "react";
import * as ReactJsxRuntime from "react/jsx-runtime";
// eslint-disable-next-line no-restricted-imports -- plugin client runtime injects host ReactNative.
import * as ReactNative from "react-native";
// eslint-disable-next-line no-restricted-imports -- plugin bundles receive TanStack's real runtime, not Q8iDevAI's query wrappers.
...
export function runPluginClientBundle(
  ...
  const runtimeRequire = (name: string): unknown => {
    if (name === "@q8idevai/plugin/client/ui") return pluginUiRuntime;
    ...
    if (name === "@q8idevai/plugin/client") return { ...pluginClientRuntime, useSettings };
    if (name === "@q8idevai/plugin/client/react-native") {
