...
describe("evaluatePluginClientBundle", () => {
  ...
  it("runs the client entry with the full runtime context", () => {
    const plugin = evaluatePluginClientBundle(
      "review",
      bundle(`
        if (!plugin.q8idevai || !plugin.rpc || !plugin.openSurface || !plugin.openPanel || !plugin.addComposerPill) {
  ...
  it("provides the host Icon component through @q8idevai/plugin/client/react-native", () => {
    const plugin = evaluatePluginClientBundle(
      "example",
      `(function(require) {
        const { Icon } = require("@q8idevai/plugin/client/react-native");
        const module = { exports: {} };
  ...
  it("provides Q8iDevAI UI through @q8idevai/plugin/client/react-native", () => {
    const plugin = evaluatePluginClientBundle(
      "example",
      `(function(require) {
        const { Icon, Modal, useToast } = require("@q8idevai/plugin/client/react-native");
        const module = { exports: {} };
        module.exports.default = function(plugin) {
  ...
  it("keeps shared and client runtime exports separate", () => {
    expect(() =>
      evaluatePluginClientBundle(
        "example",
        `(function(require) {
      const shared = require("@q8idevai/plugin");
      const client = require("@q8idevai/plugin/client");
      for (const name of ["useQ8iDevAI", "useRpc", "useSettings", "useAgent", "useWorkspace"]) {
  ...
  it("resolves shared RPC helpers from @q8idevai/plugin", () => {
    const plugin = evaluatePluginClientBundle(
      "example",
      `(function(require) {
        const { defineRpc, defineAttachmentSource } = require("@q8idevai/plugin");
