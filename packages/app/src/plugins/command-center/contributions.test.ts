...
import { type PluginCommandCenterItemContribution } from "@q8idevai/plugin/client";
...
const workspace: PluginWorkspaceSnapshot = {
  id: "workspace-1",
  projectId: "project-1",
  projectDisplayName: "Q8iDevAI",
  projectRootPath: "/repo/q8idevai",
  directory: "/repo/q8idevai/review",
  projectKind: "git",
  kind: "worktree",
  name: "Review",
  title: null,
...
describe("plugin Command Center contributions", () => {
  ...
  it("supplies the direct API, typed RPC, snapshots, and narrow navigation", async () => {
    ...
    expect(receivedQ8iDevAI).toBe(runtime.q8idevai);
