...
describe("Add Project options", () => {
  ...
  it("offers manual URL and protocol-specific owner/repo clone choices", () => {
    expect(buildManualGithubRepositoryChoices("git@github.com:getq8idevai/q8idevai.git")).toEqual([
      expect.objectContaining({
        id: "manual:git@github.com:getq8idevai/q8idevai.git",
        nameWithOwner: "getq8idevai/q8idevai",
        cloneUrl: "git@github.com:getq8idevai/q8idevai.git",
      }),
    ]);
    expect(buildManualGithubRepositoryChoices("getq8idevai/q8idevai")).toEqual([
      expect.objectContaining({ cloneProtocol: "https", cloneUrl: "getq8idevai/q8idevai" }),
      expect.objectContaining({ cloneProtocol: "ssh", cloneUrl: "getq8idevai/q8idevai" }),
    ]);
    expect(buildManualGithubRepositoryChoices("q8idevai")).toEqual([]);
  });
  ...
  it("shows final clone paths while retaining parent paths as values", () => {
    expect(
      buildCloneLocationOptions({
        ...
        repositoryName: "q8idevai",
        existingPaths: ["~/workspace/q8idevai"],
      }),
    ).toEqual([
      {
        id: "~/dev",
        path: "~/dev",
        displayPath: "~/dev/q8idevai",
      ...
      },
      {
        id: "~/workspace",
        path: "~/workspace",
        displayPath: "~/workspace/q8idevai",
