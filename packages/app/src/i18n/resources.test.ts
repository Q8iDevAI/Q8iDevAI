...
describe("translation resources", () => {
  ...
  it("localizes the pull request empty state in every supported language", () => {
    expect(ar.panels.pullRequest.emptyTitle).not.toBe(en.panels.pullRequest.emptyTitle);
    expect(ar.panels.pullRequest.emptyDescription).not.toBe(
  ...
  it("includes Settings expansion keys for the Batch 3B migration", () => {
    ...
    expect(en.settings.host.orchestration.enableTools.title).toBe("Enable Q8iDevAI tools");
  ...
  it("includes onboarding and direct connection keys for the Batch 4E migration", () => {
    expect(en.onboarding.title).toBe("Welcome to Q8iDevAI");
  ...
  it("includes remaining small utility chrome keys for the Batch 4O migration", () => {
    ...
    expect(en.desktop.quitting.title).toBe("Quitting Q8iDevAI...");
  ...
  it("includes desktop update utility keys for the Batch 4Q migration", () => {
    ...
    expect(en.desktop.rosetta.runningIntel).toBe(
      "You're running the Intel build of Q8iDevAI under Rosetta on Apple Silicon.",
    );
  ...
  it("includes desktop permission utility keys for the Batch 4R migration", () => {
    ...
    expect(en.desktop.permissions.testNotification.title).toBe("Q8iDevAI notification test");
  ...
  it("includes desktop daemon settings keys for the Batch 4S migration", () => {
    ...
    expect(en.desktop.integrations.cli.installFailed).toBe("Unable to install the Q8iDevAI CLI.");
  });
