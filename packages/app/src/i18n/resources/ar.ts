...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Q8iDevAI",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Q8iDevAI ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Q8iDevAI من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Q8iDevAI",
      },
      logs: {
        title: "ملف السجل",
      ...
      fullStatus: {
        ...
        hint: "يقوم بتشغيل`q8idevai daemon status`ويظهر الإخراج",
        view: "عرض الحالة",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Q8iDevAI ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت Q8iDevAICLI.",
      },
    },
  },
  rootError: {
    title: "واجه Q8iDevAI مشكلة.",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم Q8iDevAI.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم Q8iDevAI يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Q8iDevAI",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Q8iDevAI Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Q8iDevAI على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    q8idevaiCalls: {
      one: "استدعى Q8iDevAI {{count}} مرة",
      other: "استدعى Q8iDevAI {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم Q8iDevAI الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه Q8iDevAI لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار Q8iDevAI نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه Q8iDevAI",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم Q8iDevAI نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Q8iDevAI.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Q8iDevAI على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Q8iDevAI ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Q8iDevAI ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Q8iDevAI من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Q8iDevAI بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Q8iDevAI بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Q8iDevAI Desktop هذا البرنامج الخفي. حدّث Q8iDevAI Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "تعذر تحليل q8idevai.json",
        ...
        transportTitle: "تعذر تحميل q8idevai.json",
        transportFallback: "المضيف لم يستجب.",
        failedTitle: "تعذر تحميل q8idevai.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "ثبّت تغييرات q8idevai.json",
      ...
      scripts: {
        ...
        serviceHint: "يشرف Q8iDevAI على العملية ويعين منفذًا عبر $Q8IDEVAI_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Q8iDevAI لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
      ...
      writeFailures: {
        ...
        staleDescription: "أعد التحميل لجلب أحدث ملف q8idevai.json قبل الحفظ.",
        failedTitle: "تعذر حفظ q8idevai.json",
