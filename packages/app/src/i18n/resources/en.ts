export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Q8iDevAI start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Q8iDevAI could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Q8iDevAI",
      },
      logs: {
        title: "Log file",
      ...
      fullStatus: {
        ...
        hint: "Runs `q8idevai daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Q8iDevAI under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Q8iDevAI CLI.",
      },
    },
  },
  rootError: {
    title: "Q8iDevAI ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Q8iDevAI server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Q8iDevAI daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Q8iDevAI relay works",
      ...
      updateRequired: "Update the host to enable relay from Q8iDevAI Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Q8iDevAI on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    q8idevaiCalls: {
      one: "called Q8iDevAI {{count}} time",
      other: "called Q8iDevAI {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Q8iDevAI handed the notification to the operating system.",
    ...
    plugins: {
      ...
      idHint: "Leave blank to use q8idevai-plugin.json",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Q8iDevAI uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Q8iDevAI picks a fast available model",
      preferredHint: "Choose the model Q8iDevAI uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Q8iDevAI falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Q8iDevAI.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Q8iDevAI on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Q8iDevAI skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Q8iDevAI skills?",
        uninstallMessage:
          "Removes all Q8iDevAI orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable Q8iDevAI tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject Q8iDevAI tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Q8iDevAI reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Q8iDevAI reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "q8idevai.json couldn't be parsed",
        ...
        transportTitle: "Couldn't load q8idevai.json",
        transportFallback: "The host didn't respond.",
        failedTitle: "Couldn't load q8idevai.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "Commit q8idevai.json changes",
      ...
      scripts: {
        ...
        serviceHint: "Q8iDevAI supervises the process and assigns a port via $Q8IDEVAI_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Q8iDevAI uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
      ...
      writeFailures: {
        ...
        staleDescription: "Reload to fetch the latest q8idevai.json before saving.",
        failedTitle: "Couldn't save q8idevai.json",
