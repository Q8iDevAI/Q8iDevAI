...
import { ConnectionOfferSchema, type ConnectionOffer } from "@q8idevai/protocol/connection-offer";
...
const REGISTRY_STORAGE_KEY = "@q8idevai:daemon-registry";
const LOCALHOST_FALLBACK_ENDPOINT = "localhost:6767";
const DEFAULT_LOCALHOST_BOOTSTRAP_TIMEOUT_MS = 2500;
const E2E_STORAGE_KEY = "@q8idevai:e2e";
const INITIAL_DAEMON_CONNECTION_HINT_GLOBAL_KEY = "__Q8IDEVAI_INITIAL_DAEMON_CONNECTION__";
...
const HOST_RUNTIME_STORE_GLOBAL_KEY = "__q8idevaiHostRuntimeStore";
