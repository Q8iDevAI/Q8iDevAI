...
OUT_DIR="/tmp/q8idevai-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/q8idevai-maestro-videos"
DEVICE_VIDEO="/sdcard/q8idevai-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/q8idevai-maestro-workspace-create-focused.mp4"
