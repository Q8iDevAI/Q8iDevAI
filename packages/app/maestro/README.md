...
Start the `sh.q8idevai.debug` dev client against the intended Metro server first;
...
working with `${Q8IDEVAI_MAESTRO_*}` placeholders.
...
The scripts assume a development build with package id `sh.q8idevai.debug`, an
