...
Q8iDevAI supplies word-paced text and message-owned fade ranges with their original
...
tail; Q8iDevAI gives every grapheme an absolute start time in native Unicode visual
...
tail settles. Q8iDevAI retains its word pacing; each grapheme has an absolute start
