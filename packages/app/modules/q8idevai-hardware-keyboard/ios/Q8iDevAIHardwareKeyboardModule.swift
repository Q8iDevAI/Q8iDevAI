...
private weak var activeModule: Q8iDevAIHardwareKeyboardModule?
private var isHardwareSubmitEnabled = false

@objc
public class Q8iDevAIHardwareKeyboardReactDelegateHandler: ExpoReactDelegateHandler {
  public override func createRootViewController() -> UIViewController? {
    return Q8iDevAIHardwareKeyboardRootViewController()
  }
}

public class Q8iDevAIHardwareKeyboardModule: Module {
  public func definition() -> ModuleDefinition {
    Name("Q8iDevAIHardwareKeyboard")
...
private final class Q8iDevAIHardwareKeyboardRootViewController: UIViewController {
  ...
  private func canSubmitCurrentTextInput() -> Bool {
    guard let responder = UIResponder.q8idevaiCurrentFirstResponder else {
      return false
    }
...
private extension UIResponder {
  ...
  static var q8idevaiCurrentFirstResponder: UIResponder? {
