import { z } from "zod";
import { CHECK_TRAIT_ACTION_REQUIRED, CHECK_TRAIT_WARNING } from "@q8idevai/protocol/check-traits";
import { mapGiteaCommitState } from "@q8idevai/protocol/gitea-status";
...
/**
 * Probe whether a host is a Gitea instance Q8iDevAI can talk to. tea has no
 ...
 * null when there is no usable `tea` login (Q8iDevAI cannot operate the host),
