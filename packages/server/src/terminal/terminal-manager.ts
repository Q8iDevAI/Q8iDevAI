...
import { deriveTerminalActivityStatusBucket } from "@q8idevai/protocol/terminal-activity";
  ...
  return {
    ...
    async createTerminal(options: {
      ...
      const activityEnv = {
        ...
        Q8IDEVAI_ACTIVITY_TOKEN: activityToken,
        ...(terminalActivityUrl ? { Q8IDEVAI_TERMINAL_ACTIVITY_URL: terminalActivityUrl } : {}),
      };
