...
import type { Q8iDevAIOpenAIConfig, Q8iDevAISpeechConfig } from "../bootstrap.js";
...
function buildFeatureProviderInputs(params: {
  ...
  const voiceModeEnabled = resolveOptionalBooleanFlag(
    firstSpeechDefinedValue<string | boolean>([
      params.env.Q8IDEVAI_VOICE_MODE_ENABLED,
  ...
  return {
    ...
    voiceTurnDetection: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.Q8IDEVAI_VOICE_TURN_DETECTION_PROVIDER,
    ...
    voiceStt: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.Q8IDEVAI_VOICE_STT_PROVIDER,
    ...
    voiceTts: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.Q8IDEVAI_VOICE_TTS_PROVIDER,
...
export function resolveSpeechConfig(params: {
  ...
  openai: Q8iDevAIOpenAIConfig | undefined;
  ...
  const local = resolveLocalSpeechConfig({
    q8idevaiHome: params.q8idevaiHome,
    env: params.env,
    persisted: params.persisted,
    providers,
  });
