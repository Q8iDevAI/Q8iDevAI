...
describe("resolveSpeechConfig", () => {
  test("resolves local-first defaults without env overrides", () => {
    const q8idevaiHome = "/tmp/q8idevai-home";
    ...
    expect(result.speech.local).toEqual({
      modelsDir: path.join(q8idevaiHome, "models", "local-speech"),
      models: {
  ...
  test("resolves feature-scoped local speech settings", () => {
    ...
    const env = {
      ...
      Q8IDEVAI_VOICE_LOCAL_TTS_SPEAKER_ID: "5",
      Q8IDEVAI_VOICE_LOCAL_TTS_SPEED: "1.35",
      Q8IDEVAI_DICTATION_LANGUAGE: "es",
      Q8IDEVAI_VOICE_LANGUAGE: "pt",
      Q8IDEVAI_LOCAL_MODELS_DIR: "/tmp/models",
      OPENAI_API_KEY: "env-key",
      Q8IDEVAI_VOICE_STT_PROVIDER: "openai",
      Q8IDEVAI_DICTATION_STT_PROVIDER: "local",
      Q8IDEVAI_VOICE_TTS_PROVIDER: "local",
