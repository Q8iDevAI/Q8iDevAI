...
import type { Q8iDevAISpeechConfig } from "../../../bootstrap.js";
...
function resolveConfiguredLocalModels(speechConfig: Q8iDevAISpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: Q8iDevAISpeechConfig | null,
