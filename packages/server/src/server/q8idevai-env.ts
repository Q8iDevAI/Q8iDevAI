...
export type Q8iDevAINodeEnv = "development" | "production" | "test";
...
export function createQ8iDevAIInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveQ8iDevAINodeEnv(env: NodeJS.ProcessEnv): Q8iDevAINodeEnv | undefined {
  const value = env[Q8IDEVAI_NODE_ENV];
