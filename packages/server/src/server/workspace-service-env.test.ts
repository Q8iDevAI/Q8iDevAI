...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      Q8IDEVAI_PORT: "5173",
      Q8IDEVAI_URL: "http://daemon--q8idevai.localhost:6767",
      Q8IDEVAI_SERVICE_DAEMON_PORT: "5173",
      Q8IDEVAI_SERVICE_DAEMON_URL: "http://daemon--q8idevai.localhost:6767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      Q8IDEVAI_PORT: "5173",
      Q8IDEVAI_URL: "http://daemon--feature-x--q8idevai.localhost:6767",
      Q8IDEVAI_SERVICE_DAEMON_PORT: "5173",
      Q8IDEVAI_SERVICE_DAEMON_URL: "http://daemon--feature-x--q8idevai.localhost:6767",
    });
  });

  it("omits PORT while keeping Q8IDEVAI_PORT", () => {
    ...
    expect(env.Q8IDEVAI_PORT).toBe("5173");
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      Q8IDEVAI_PORT: "5173",
      Q8IDEVAI_URL: "http://web--feature-x--q8idevai.localhost:6767",
      Q8IDEVAI_SERVICE_API_PORT: "4000",
      Q8IDEVAI_SERVICE_API_URL: "http://api--feature-x--q8idevai.localhost:6767",
      Q8IDEVAI_SERVICE_WEB_PORT: "5173",
      Q8IDEVAI_SERVICE_WEB_URL: "http://web--feature-x--q8idevai.localhost:6767",
    });
  });
  ...
  it("uses public service URLs when a public base URL is configured", () => {
    expect(
      ...
      Q8IDEVAI_URL: "https://web--feature-x--q8idevai.services.example.com",
      Q8IDEVAI_SERVICE_API_URL: "https://api--feature-x--q8idevai.services.example.com",
      Q8IDEVAI_SERVICE_WEB_URL: "https://web--feature-x--q8idevai.services.example.com",
    });
  });
