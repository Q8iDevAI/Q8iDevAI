...
const MANIFEST_OWNER = "q8idevai-skills-transaction";
const MANIFEST_FILENAME = "transaction.json";
const TRANSACTION_PREFIX = ".q8idevai-skills-transaction-";
const RECOVERED_PREFIX = ".q8idevai-skills-recovered-";
const BACKUP_DIRNAME = "backup";
const MANAGED_FILES_MANIFEST = ".q8idevai-managed-files.json";
