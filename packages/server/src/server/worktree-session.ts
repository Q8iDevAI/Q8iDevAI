...
interface CreateQ8iDevAIWorktreeInBackgroundDependencies {
  q8idevaiHome?: string;
  worktreesRoot?: string;
...
interface CreateQ8iDevAIWorktreeWorkflowDependencies extends CreateQ8iDevAIWorktreeInBackgroundDependencies {
  createQ8iDevAIWorktree: (
    input: CreateQ8iDevAIWorktreeInput,
    options?: {
      resolveDefaultBranch?: (repoRoot: string) => Promise<string>;
...
export type CreateQ8iDevAIWorktreeSetupContinuationInput =
  | { kind: "workspace" }
...
export type CreateQ8iDevAIWorktreeWorkflowResult = CreateQ8iDevAIWorktreeResult & {
  setupContinuation?: AgentWorktreeSetupContinuation;
};

export type CreateQ8iDevAIWorktreeWorkflowFn = (
  input: CreateQ8iDevAIWorktreeInput,
  options?: {
    resolveDefaultBranch?: (repoRoot: string) => Promise<string>;
    setupContinuation?: CreateQ8iDevAIWorktreeSetupContinuationInput;
...
interface HandleWorkspaceSetupRunRequestDependencies extends CreateQ8iDevAIWorktreeInBackgroundDependencies {
  getWorkspace: (workspaceId: string) => Promise<PersistedWorkspaceRecord | null>;
  clearAutomationBlock: (workspaceId: string) => Promise<boolean>;
  startWorkspaceSetup: (workspaceId: string, operation: WorkspaceSetupOperation) => void;
}

interface HandleCreateQ8iDevAIWorktreeRequestDependencies {
  q8idevaiHome?: string;
  worktreesRoot?: string;
...
export async function buildAgentSessionConfig(
  ...
  if (normalized.createWorktree) {
    ...
    const createdWorktree = await dependencies.createQ8iDevAIWorktree(
      {
        cwd,
...
export async function handleQ8iDevAIWorktreeListRequest(
  dependencies: {
    emit: EmitSessionMessage;
    q8idevaiHome?: string;
    workspaceGitService: WorkspaceGitService;
  ...
  try {
    const worktrees = await listQ8iDevAIWorktreesCommand(
...
export async function handleQ8iDevAIWorktreeArchiveRequest(
  dependencies: Omit<
    ArchiveDependencies,
  ...
  try {
    ...
    if (!result.ok) {
      dependencies.emit({
        type: "q8idevai_worktree_archive_response",
        payload: {
          success: false,
...
export async function handleCreateQ8iDevAIWorktreeRequest(
  dependencies: HandleCreateQ8iDevAIWorktreeRequestDependencies,
  request: Extract<SessionInboundMessage, { type: "create_q8idevai_worktree_request" }>,
): Promise<void> {
  try {
    const commandResult = await createQ8iDevAIWorktreeCommand(
      {
        q8idevaiHome: dependencies.q8idevaiHome,
        worktreesRoot: dependencies.worktreesRoot,
        createQ8iDevAIWorktreeWorkflow: dependencies.createQ8iDevAIWorktreeWorkflow,
      },
      {
        cwd: request.cwd,
...
export async function createQ8iDevAIWorktreeWorkflow(
  dependencies: CreateQ8iDevAIWorktreeWorkflowDependencies,
  input: CreateQ8iDevAIWorktreeInput,
  options?: {
    resolveDefaultBranch?: (repoRoot: string) => Promise<string>;
    setupContinuation?: CreateQ8iDevAIWorktreeSetupContinuationInput;
...
export async function runWorktreeSetupInBackground(
  dependencies: CreateQ8iDevAIWorktreeInBackgroundDependencies,
  options: {
    requestCwd: string;
    repoRoot: string;
    workspaceId: string;
