...
function tmpHome(): string {
  return mkdtempSync(path.join(tmpdir(), "q8idevai-server-id-"));
}
...
describe("getOrCreateServerId", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.Q8IDEVAI_SERVER_ID;
    home = tmpHome();
  });
  ...
  it("creates and persists a stable id per Q8IDEVAI_HOME", () => {
  ...
  it("respects and persists Q8IDEVAI_SERVER_ID override", () => {
    process.env.Q8IDEVAI_SERVER_ID = "test-daemon-id";
