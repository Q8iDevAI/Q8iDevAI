...
const relayEndpoint = process.env.Q8IDEVAI_LIVE_RELAY_ENDPOINT ?? "q8idevai-relay-next.fly.dev:443";
...
async function pairingOfferFor(daemon: TestQ8iDevAIDaemon): Promise<ConnectionOffer> {
