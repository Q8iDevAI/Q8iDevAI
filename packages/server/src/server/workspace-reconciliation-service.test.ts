...
describe("WorkspaceReconciliationService", () => {
  ...
  test("keeps legacy duplicate projects and workspace membership intact", async () => {
    ...
    const canonicalWorktreeDir = path.join(repoDir, ".q8idevai", "worktrees", "focused-bat");
    const duplicateWorktreeDir = path.join(repoDir, ".q8idevai", "worktrees", "gigantic-blowfish");
