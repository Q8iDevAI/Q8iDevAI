...
import { defineSettings, settingsRpc, type SettingsDefinition } from "@q8idevai/plugin";
import type { PluginSettings, PluginSettingsState } from "@q8idevai/plugin/server";
