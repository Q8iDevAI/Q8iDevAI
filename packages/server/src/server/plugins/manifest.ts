...
import { z } from "zod";
import { PluginIdSchema, PluginRequirementsSchema } from "@q8idevai/protocol/messages";
import { validatePluginRequirements } from "@q8idevai/protocol/plugin-requirements";

const MANIFEST_FILENAME = "q8idevai-plugin.json";
