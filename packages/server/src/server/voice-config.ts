const VOICE_PROMPT_BLOCK_START = "<q8idevai_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</q8idevai_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Q8iDevAI voice mode is now on.",
  "You are the Q8iDevAI voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Q8iDevAI voice mode is now off.",
  "Ignore any earlier Q8iDevAI voice mode instructions in this thread.",
].join(" ");
