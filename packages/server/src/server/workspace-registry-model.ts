...
export type PersistedWorkspacePlacement = Pick<
  ...
  | "worktreeRoot"
  | "baseBranch"
  | "isQ8iDevAIOwnedWorktree"
  | "mainRepoRoot"
>;

export type MutableWorkspacePlacement = Pick<
  PersistedWorkspaceRecord,
  "kind" | "branch" | "worktreeRoot" | "isQ8iDevAIOwnedWorktree" | "mainRepoRoot"
>;
...
export function initialWorkspacePlacement(
  ...
  return {
    ...
    baseBranch: null,
    isQ8iDevAIOwnedWorktree: input.checkout.isGit && input.checkout.isQ8iDevAIOwnedWorktree,
...
export function reconcileWorkspacePlacement(input: {
  ...
  if (input.workspace.isQ8iDevAIOwnedWorktree !== observed.isQ8iDevAIOwnedWorktree)
    fields.isQ8iDevAIOwnedWorktree = observed.isQ8iDevAIOwnedWorktree;
...
export function checkoutFromPersistedWorkspacePlacement(input: {
  ...
  if (workspace.isQ8iDevAIOwnedWorktree && workspace.mainRepoRoot) {
    return {
      ...checkout,
      isGit: true,
      isQ8iDevAIOwnedWorktree: true,
...
export function checkoutLiteFromGitSnapshot(
  ...
  if (git.isQ8iDevAIOwnedWorktree && git.mainRepoRoot) {
    return {
      cwd,
      isGit: true,
