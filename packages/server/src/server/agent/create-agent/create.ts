...
import type { CreateQ8iDevAIWorktreeInput } from "../../q8idevai-worktree-service.js";
import { expandUserPath, resolvePathFromBase } from "../../path-utils.js";
import { toWorktreeRequestError } from "../../worktree-errors.js";
import type {
  AgentWorktreeSetupContinuation,
  CreateQ8iDevAIWorktreeSetupContinuationInput,
  CreateQ8iDevAIWorktreeWorkflowFn,
  CreateQ8iDevAIWorktreeWorkflowResult,
...
export interface CreateAgentFromMcpInput {
  ...
  onWorktreeCreated?: (createdWorktree: CreateQ8iDevAIWorktreeWorkflowResult) => void;
...
export interface CreateAgentCommandResult {
  ...
  createdWorktree?: CreateQ8iDevAIWorktreeWorkflowResult;
}
...
async function resolveMcpCwd(params: {
  ...
  const createdWorktree = await createMcpWorktree({
    ...
    createQ8iDevAIWorktree: dependencies.createQ8iDevAIWorktree,
...
interface CreateMcpWorktreeOptions {
  ...
  createQ8iDevAIWorktree: CreateQ8iDevAIWorktreeWorkflowFn | undefined;
...
async function createMcpWorktree(
  ...
  try {
    if (!options.createQ8iDevAIWorktree) {
      throw new Error("Q8iDevAI worktree service is not configured");
    }
    return await options.createQ8iDevAIWorktree(options.input, {
