...
describe("prompt attachments", () => {
  ...
  it("renders GitLab change request attachments with MR numbering", () => {
    expect(
      renderPromptAttachmentAsText({
        ...
        mimeType: "application/q8idevai-forge-change-request",
        forge: "gitlab",
        number: 123,
        title: "Fix race in worktree setup",
        url: "https://gitlab.com/getq8idevai/q8idevai/-/merge_requests/123",
        body: "MR body",
        projectPath: "getq8idevai/q8idevai",
        baseRefName: "main",
        headRefName: "fix/worktree-race",
      }),
  ...
  it("renders review attachments with compact file, line, comment, and context details", () => {
    expect(
      renderPromptAttachmentAsText({
        type: "review",
        mimeType: "application/q8idevai-review",
        cwd: "/tmp/repo",
        mode: "base",
        baseRef: "main",
        comments: [
      ...
      [
        "Q8iDevAI review attachment (base)",
        "CWD: /tmp/repo",
        "Base: main",
        "",
