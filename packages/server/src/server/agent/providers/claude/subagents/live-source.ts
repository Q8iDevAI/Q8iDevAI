 ...
 *
 * Verified on the wire (Claude Code 2.1.220, Q8iDevAI's own query options):
 *
...
export class ClaudeTaskProtocolSource {
   ...
   * value Q8iDevAI requested is not necessarily the one that ran, because a model that does not
