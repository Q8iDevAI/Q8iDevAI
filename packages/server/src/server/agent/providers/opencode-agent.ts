...
const OPENCODE_SESSION_ENV_KEYS = new Set(["Q8IDEVAI_AGENT_ID", "Q8IDEVAI_AGENT_CWD"]);
...
export class OpenCodeAgentClient implements AgentClient {
  ...
  constructor(
    ...
    this.capabilities = {
      ...
      ...(this.bridge ? { supportsNativeQ8iDevAITools: true } : {}),
    };
  ...
  private bindBridgeSession(
    ...
    return this.bridge.bindSession({
      ...
      tools: launchContext.q8idevaiTools,
    });
  }
