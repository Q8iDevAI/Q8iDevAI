...
import type { Q8iDevAIToolDefinition, Q8iDevAIToolResult } from "./types.js";
...
export function addModelVisibleStructuredContent(result: Q8iDevAIToolResult): Q8iDevAIToolResult {
...
export function serializeQ8iDevAIToolInputParameters(
  tool: Q8iDevAIToolDefinition,
