...
import type { ActiveTurnBehavior } from "@q8idevai/protocol/messages";
...
/**
 * Wrap a body in <q8idevai-system>…</q8idevai-system> so the receiving agent
...
export function formatSystemNotificationPrompt(reason: string): string {
  return `<q8idevai-system>\n${reason}\n</q8idevai-system>`;
}

const SYSTEM_ENVELOPE_PATTERN = /^<q8idevai-system>\n[\s\S]*\n<\/q8idevai-system>$/;
