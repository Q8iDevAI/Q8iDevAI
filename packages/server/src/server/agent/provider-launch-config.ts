...
import { createExternalProcessEnv, type ProcessEnvRecord } from "../q8idevai-env.js";
export {
...
} from "@q8idevai/protocol/provider-config";
import {
  ProviderOverrideSchema,
  ProviderOverridesSchema,
  ProviderRuntimeSettingsSchema,
...
// launched from inside Claude Code (e.g. by a Q8iDevAI agent), these leak into
