import { readQ8iDevAIConfigJson } from "./q8idevai-config-file.js";
import {
...
// owner replaces it wholesale via q8idevai.json metadataGeneration.<configKey>.instructions
...
async function readProjectMetadataOverrides(
...
): Promise<Q8iDevAIMetadataGeneration | undefined> {
  ...
  try {
    ...
    return Q8iDevAIConfigSchema.parse(json).metadataGeneration;
  } catch {
    return undefined;
  }
}
