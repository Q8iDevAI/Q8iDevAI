...
import { getQ8iDevAIToolLeafName, isQ8iDevAIToolName } from "./tool-name-normalization.js";
...
function humanizeToolName(name: string): string {
  ...
  if (isQ8iDevAIToolName(trimmed)) {
    const leaf = getQ8iDevAIToolLeafName(trimmed);
    if (leaf) {
