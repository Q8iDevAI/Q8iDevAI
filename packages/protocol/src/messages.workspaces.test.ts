...
describe("workspace message schemas", () => {
          ...
          scripts: [
            {
              ...
              port: 3000,
              proxyUrl: "http://web.q8idevai.localhost:6767",
              lifecycle: "running",
              health: "healthy",
            },
          ],
  ...
  test("preserves a Q8iDevAI-owned worktree slug", () => {
    const parsed = WorkspaceDescriptorPayloadSchema.parse({
      id: "owned-worktree",
      projectId: "project",
      projectDisplayName: "repo",
      projectRootPath: "/repo",
      workspaceDirectory: "/q8idevai/worktrees/project/feature/packages/app",
          ...
          commands: [
            {
              index: 1,
              command: "npm install",
              cwd: "/repo/.q8idevai/worktrees/feature-a",
              log: "done",
              status: "completed",
              exitCode: 0,
              durationMs: 100,
