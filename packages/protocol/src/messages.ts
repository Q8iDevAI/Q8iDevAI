...
import { ProviderQ8iDevAIToolsPolicySchema } from "./provider-config.js";
...
import {
  ...
  Q8iDevAIMetadataGenerationEntrySchema,
  Q8iDevAIMetadataGenerationSchema,
  ...
  type Q8iDevAIMetadataGeneration,
  type Q8iDevAIMetadataGenerationEntry,
  type Q8iDevAIScriptEntryRaw,
  type ProjectConfigRpcError,
} from "./q8idevai-config-schema.js";
export {
  Q8iDevAIConfigRawSchema,
  Q8iDevAILifecycleCommandRawSchema,
  Q8iDevAIMetadataGenerationEntrySchema,
...
const MutableDaemonProviderConfigSchema = z
  .object({
    q8idevaiTools: ProviderQ8iDevAIToolsPolicySchema.optional(),
...
export const PluginRequirementsSchema = z.object({ q8idevai: z.string().optional() });
...
export const ForgeChangeRequestAttachmentSchema = z.object({
  ...
  mimeType: z.literal("application/q8idevai-forge-change-request"),
...
export const ForgeIssueAttachmentSchema = z.object({
  ...
  mimeType: z.literal("application/q8idevai-forge-issue"),
  forge: z.string().optional().default("github"),
  number: z.number().int().positive(),
  title: z.string(),
  url: z.string(),
...
export const ReviewAttachmentSchema = z.object({
  ...
  mimeType: z.literal("application/q8idevai-review"),
  cwd: z.string(),
...
export const WriteProjectConfigRequestMessageSchema = z.object({
  ...
  requestId: z.string(),
  repoRoot: z.string(),
  config: Q8iDevAIConfigRawSchema,
  expectedRevision: Q8iDevAIConfigRevisionSchema.nullable(),
});
...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return q8idevai-created stashes. Default true. */
  q8idevaiOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const Q8iDevAIWorktreeListRequestSchema = z.object({
  type: z.literal("q8idevai_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const Q8iDevAIWorktreeArchiveRequestSchema = z.object({
  type: z.literal("q8idevai_worktree_archive_request"),
  ...
  // Q8iDevAI-owned. Omitted/unknown values default to "workspace" for old-client safety.
...
export const CreateQ8iDevAIWorktreeRequestSchema = z.object({
  type: z.literal("create_q8idevai_worktree_request"),
  cwd: z.string(),
  projectId: z.string().optional(),
  worktreeSlug: z.string().optional(),
...
// between an existing local directory and a newly created q8idevai worktree.
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  Q8iDevAIWorktreeListRequestSchema,
  Q8iDevAIWorktreeArchiveRequestSchema,
  CreateQ8iDevAIWorktreeRequestSchema,
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isQ8iDevAIOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonQ8iDevAIPayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitQ8iDevAIPayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isQ8iDevAIOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonQ8iDevAIPayloadSchema,
  ProjectCheckoutLiteGitQ8iDevAIPayloadSchema,
]);
...
const WorkspaceGitRuntimePayloadSchema = z
  .object({
    ...
    isQ8iDevAIOwnedWorktree: z.boolean().optional(),
...
export const WorkspaceDescriptorPayloadSchema = z
  .object({
    ...
    // Present only for Q8iDevAI-owned worktrees; this is the basename of their root directory.
    worktreeSlug: z.string().optional(),
...
export const ReadProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.union([
    z.object({
      ...
      repoRoot: z.string(),
      ok: z.literal(true),
      config: Q8iDevAIConfigRawSchema.nullable(),
      revision: Q8iDevAIConfigRevisionSchema.nullable(),
...
export const WriteProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.union([
    z.object({
      ...
      ok: z.literal(true),
      config: Q8iDevAIConfigRawSchema,
      revision: Q8iDevAIConfigRevisionSchema,
      hasUncommittedWorktreeSetupChanges: z.boolean().optional(),
    }),
    z.object({
      requestId: z.string(),
...
const CheckoutStatusGitNonQ8iDevAISchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isQ8iDevAIOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  mainRepoRoot: z.string().nullable().optional().default(null),
...
const CheckoutStatusGitQ8iDevAISchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isQ8iDevAIOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonQ8iDevAISchema,
    CheckoutStatusGitQ8iDevAISchema,
  ]),
});
...
const Q8iDevAIWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const Q8iDevAIWorktreeListResponseSchema = z.object({
  type: z.literal("q8idevai_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(Q8iDevAIWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const Q8iDevAIWorktreeArchiveResponseSchema = z.object({
  type: z.literal("q8idevai_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateQ8iDevAIWorktreeResponseSchema = z.object({
  type: z.literal("create_q8idevai_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  Q8iDevAIWorktreeListResponseSchema,
  Q8iDevAIWorktreeArchiveResponseSchema,
  CreateQ8iDevAIWorktreeResponseSchema,
...
export type CreateQ8iDevAIWorktreeRequest = z.infer<typeof CreateQ8iDevAIWorktreeRequestSchema>;
...
export type Q8iDevAIWorktreeListRequest = z.infer<typeof Q8iDevAIWorktreeListRequestSchema>;
export type Q8iDevAIWorktreeListResponse = z.infer<typeof Q8iDevAIWorktreeListResponseSchema>;
export type Q8iDevAIWorktreeArchiveRequest = z.infer<typeof Q8iDevAIWorktreeArchiveRequestSchema>;
export type Q8iDevAIWorktreeArchiveResponse = z.infer<typeof Q8iDevAIWorktreeArchiveResponseSchema>;
