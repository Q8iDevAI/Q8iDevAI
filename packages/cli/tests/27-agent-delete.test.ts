...
const q8idevaiHome = await mkdtemp(join(tmpdir(), "q8idevai-delete-test-home-"));

async function runCli(args: string[]) {
  return runLocalQ8iDevAI(["--host", `localhost:${port}`, ...args], { Q8IDEVAI_HOME: q8idevaiHome });
}
...
try {
  ...
  {
    console.log("Test 7: q8idevai --help shows delete command");
    ...
    console.log("✓ q8idevai --help shows delete command\n");
  }
