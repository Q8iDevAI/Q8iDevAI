...
const existingProject = join(await mkdtemp(join(tmpdir(), "q8idevai-open-project-")), "project");
...
const previousDesktopCli = process.env.Q8IDEVAI_DESKTOP_CLI;
process.env.Q8IDEVAI_DESKTOP_CLI = "1";
...
process.env.Q8IDEVAI_DESKTOP_CLI = previousDesktopCli;
