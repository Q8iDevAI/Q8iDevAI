...
/**
 * Regression: `q8idevai daemon stop` must leave a reachable daemon alone when the
...
const q8idevaiHome = await mkdtemp(join(tmpdir(), "q8idevai-stop-stale-reachable-"));
