...
describe("parseScheduleCreateInput cwd/host validation", () => {
  ...
  test("Q8IDEVAI_HOST without cwd → throws MISSING_CWD", () => {
    const daemonTarget = selectDaemonTarget({}, { Q8IDEVAI_HOST: "dev:12345" });
  ...
  test("explicit home beats Q8IDEVAI_HOST and defaults cwd locally", () => {
    const daemonTarget = selectDaemonTarget({ home: process.cwd() }, { Q8IDEVAI_HOST: "dev:12345" });
