 ...
 * - `q8idevai agent ls`    → active non-archived agents
 * - `q8idevai agent ls -g` → global non-archived agents
 * - `q8idevai agent ls -a` → active agents, including archived
 * - `q8idevai agent ls -ag` → global agents, including archived
 */
