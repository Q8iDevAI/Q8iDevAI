import { AgentSnapshotPayloadSchema } from "@q8idevai/protocol/messages";
import type { AgentSnapshotPayload, SessionOutboundMessage } from "@q8idevai/protocol/messages";
import {
  deriveAgentStateBucket,
  getWorkspaceStateBucketPriority,
} from "@q8idevai/protocol/agent-state-bucket";
...
function workspaceKind(checkout: AgentEntry["project"]["checkout"]): Workspace["workspaceKind"] {
  ...
  if (checkout.isQ8iDevAIOwnedWorktree) return "worktree";
  return "checkout";
}
...
function gitRuntime(checkout: AgentEntry["project"]["checkout"]): Workspace["gitRuntime"] {
  ...
  return {
    ...
    isQ8iDevAIOwnedWorktree: checkout.isQ8iDevAIOwnedWorktree,
    isDirty: null,
    aheadBehind: null,
    aheadOfOrigin: null,
    behindOfOrigin: null,
