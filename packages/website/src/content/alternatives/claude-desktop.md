...
description: Q8iDevAI is an open source Claude Desktop alternative that runs on your machines without a required Q8iDevAI account, telemetry, or cloud service.
nav: Claude Desktop
order: 55
---

# Q8iDevAI vs Claude Desktop
...
Q8iDevAI is an open source control plane that runs on machines you control. It does not require a Q8iDevAI account, collect telemetry, or depend on a Q8iDevAI cloud service. Connect directly from desktop, mobile, web, or the CLI, or use the optional end-to-end encrypted relay when the daemon is behind a firewall.

Q8iDevAI does not upload or store your code. The relay cannot read your code, messages, or agent output. You can also self-host the daemon, web client, and relay.

## Architecture

Q8iDevAI runs an independent daemon on your laptop, workstation, VM, home lab, or cloud machine. Its clients connect directly or through the optional end-to-end encrypted relay. The daemon launches your installed providers with their existing credentials, skills, MCP servers, and project configuration.
...
Both Claude Desktop and Q8iDevAI are available on macOS, Windows, and Linux.
...
```bash
q8idevai run --provider claude "implement OAuth"
q8idevai run --provider codex --worktree refactor-auth "refactor auth"
...
|                              | Q8iDevAI                                                           | Claude Desktop                       |
| ---------------------------- | --------------------------------------------------------------- | ------------------------------------ |
| License                      | Open source (Apache-2.0)                                        | Not published as open source         |
| Desktop platforms            | macOS, Linux, Windows                                           | macOS, Linux, Windows                |
| Mobile coding workflow       | Native Q8iDevAI workspace on iOS and Android                       | Dispatch and Cowork in Claude mobile |
...
See also: [Q8iDevAI vs Codex App](/alternatives/codex-app), [Q8iDevAI vs OpenCode Desktop](/alternatives/opencode-desktop), [Q8iDevAI vs Conductor](/alternatives/conductor).
