...
export const Route = createFileRoute("/download")({
  ...
  head: () =>
    pageMeta(
      "Download Q8iDevAI for macOS, Windows, Linux, iOS, and Android",
      "Install Q8iDevAI on every platform. Native desktop apps for macOS, Windows, and Linux. Mobile apps for iOS and Android. Self-hosted, open source, free to download.",
      "/download",
    ),
  component: Download,
});
  ...
  return (
    <SiteShell width="default">
        ...
        <div className="divide-y divide-border">
          ...
          {!onBeta && (
            <PlatformRow icon={TerminalIcon} label="Homebrew">
              <CodeBlock size="sm">brew install --cask q8idevai</CodeBlock>
            </PlatformRow>
          )}
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Run the Q8iDevAI server anywhere, connect from any client
            </p>
          </div>
        ...
        <div className="divide-y divide-border">
          <PlatformRow icon={TerminalIcon} label="npm">
            <CodeBlock size="sm">
              {onBeta
                ? "npm install -g @q8idevai/cli@beta && q8idevai"
                : "npm install -g @q8idevai/cli && q8idevai"}
            </CodeBlock>
          </PlatformRow>
          ...
          <PlatformRow icon={TerminalIcon} label="Nix">
            <CodeBlock size="sm">
              {onBeta
                ? `nix run github:getq8idevai/q8idevai/v${version}`
                : "nix run github:getq8idevai/q8idevai"}
            </CodeBlock>
          </PlatformRow>
        </div>
      </section>
      ...
      <p className="text-center text-xs text-muted-foreground mt-8">
        ...
        <a
          href="https://github.com/Q8iDevAI/Q8iDevAI/releases"
          target="_blank"
