...
import { LegalPage, Q8iDevAILegalIdentity } from "~/components/legal-page";
import { pageMeta } from "~/meta";

export const Route = createFileRoute("/terms")({
  head: () =>
    pageMeta(
      "Terms of Service - Q8iDevAI",
      "Terms for the official Q8iDevAI Relay and hosted Q8iDevAI Hub services.",
      "/terms",
    ),
  component: Terms,
});
...
function Terms() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 29, 2026">
      <p>
        These Terms govern the official services operated at q8idevai.sh, relay.q8idevai.sh, and
        hub.q8idevai.sh. By using the official relay or hosted Hub, you agree to them. Our{" "}
        <a href="/privacy">Privacy Policy</a> explains how those services process data.
      </p>

      <section>
        <h2>Who provides the services</h2>
        <Q8iDevAILegalIdentity />
      </section>

      <section>
        <h2>Q8iDevAI&apos;s open-source software</h2>
        <p>
          Q8iDevAI is open-source software licensed under the Apache License 2.0. You can install,
          modify, and self-host it under that license without purchasing Q8iDevAI Hub or using the
          official relay.
        </p>
        <p>
          These Terms do not replace or restrict the open-source license. They apply only to
          services operated by Q8iDevAI. A self-hosted Hub or relay is operated by whoever hosts it.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The relay is an optional service that connects Q8iDevAI clients to your daemon without
      ...
      <section>
        ...
        <p>
          ...
          You give Q8iDevAI only the permission needed to receive, transmit, store, and process that
      ...
      <section>
        ...
        <p>
          Stripe processes payments. Q8iDevAI does not store complete payment-card details. Nothing in
      ...
      <section>
        ...
        <p>
          Q8iDevAI can connect to services such as GitHub, Slack, Discord, Linear, Anthropic, and
          OpenAI. Those services have their own terms and privacy policies. Q8iDevAI is not responsible
      ...
      <section>
        ...
        <p>
          ...
          without implied warranties. Q8iDevAI is not liable for indirect or consequential losses
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:Admin@Q8iDev.CoM">Admin@Q8iDev.CoM</a>.
        </p>
      </section>
    </LegalPage>
  );
