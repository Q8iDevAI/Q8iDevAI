...
export const Route = createFileRoute("/privacy")({
  head: () =>
    pageMeta(
      "Privacy Policy - Q8iDevAI",
      "What stays on your machines, what the encrypted relay can see, and what Q8iDevAI Hub stores.",
      "/privacy",
    ),
  component: Privacy,
});
...
function Privacy() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="August 29, 2026">
      <p>
        Q8iDevAI is local-first. Installing or using the open-source software does not send us your
        code, prompts, files, terminal output, or agent conversations. This policy explains the
        separate data boundaries for local Q8iDevAI, the optional official relay, the hosted Q8iDevAI Hub,
        and q8idevai.sh.
      </p>
      ...
      <section>
        ...
        <p>
          MOHAMMAD MOFTAH is the data controller for personal data processed through the
          official Q8iDevAI website, relay, and hosted Hub. Independently self-hosted daemons, Hubs,
          and relays are controlled by their operators and are not covered by this policy.
        </p>
      </section>

      <section>
        <h2>Local Q8iDevAI apps and daemons</h2>
        <p>
          Q8iDevAI runs on your machines. It does not send us analytics, telemetry, advertising
        ...
        <p>
          ...
          credentials on your machine. Q8iDevAI does not manage or intercept those provider API calls.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Q8iDevAI controls account, billing, security, and service-operation data. When an
          organization uses Hub to process personal data in its workflows, that organization decides
          why the data is processed and Q8iDevAI processes it on the organization&apos;s behalf.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:Admin@Q8iDev.CoM">Admin@Q8iDev.CoM</a>. You may also complain to the{" "}
      ...
      <section>
        ...
        <p>
          ...
          service can guarantee absolute security. Read Q8iDevAI&apos;s{" "}
          <a
            href="https://github.com/Q8iDevAI/Q8iDevAI/blob/main/SECURITY.md"
            target="_blank"
