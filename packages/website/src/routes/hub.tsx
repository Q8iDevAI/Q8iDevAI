...
export const Route = createFileRoute("/hub")({
  head: () =>
    pageMeta(
      "Q8iDevAI Hub - GitHub, Slack, and Discord triggers",
      "Run Q8iDevAI Hub yourself and start agents on your own machines from GitHub, Slack, and Discord.",
      "/hub",
    ),
  loader: async () => {
    try {
...
const HOSTED_HUB_URL = "https://hub.q8idevai.sh";
...
function Hub() {
  ...
  return (
    <SiteShell width="default">
      <h1 className="text-3xl font-medium tracking-tight mb-4">Q8iDevAI Hub</h1>
  ...
  return (
    <section className="space-y-6" aria-labelledby="pricing-heading">
      <div className="space-y-2">
        ...
        <p className="max-w-2xl leading-relaxed text-white/70">
          Both options use Q8iDevAI daemons to run agents on your machines.
        </p>
      </div>
    ...
    <figure className="space-y-3">
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02]">
        ...
        <div className="space-y-5 p-5">
          <DemoMessage author="q8idev" time="09:41">
            <p>
              <Mention /> show me the latest P0 issues
            </p>
          </DemoMessage>

          <DemoMessage author="q8idevai-bot" time="09:41" bot>
          ...
          <DemoMessage author="q8idev" time="09:43">
            <p>
              <Mention /> create a pull request for the first one
            </p>
          </DemoMessage>

          <DemoMessage author="q8idevai-bot" time="09:48" bot>
            <p>
...
function Mention() {
  return <span className="rounded bg-indigo-400/15 px-1 py-0.5 text-indigo-200">@q8idevai-bot</span>;
}
    ...
    <section className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
        <div className="flex flex-col items-center">
          ...
          <DiagramRow label="Q8iDevAI apps">
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        <FAQItem question="What is the Hub?">
          A separate service that sits above your Q8iDevAI daemons. You connect one or more daemons to
          it and it gives them GitHub, Slack, and Discord triggers, with collaboration features
          planned. Q8iDevAI works fully without it.
        </FAQItem>
        <FAQItem question="Why is it a separate service instead of part of the daemon?">
          <p>
            ...
            same RPCs the app and the CLI use, so anyone can build their own hub on top of Q8iDevAI.
          </p>
          <p>
        ...
        <FAQItem question="Can I run it myself?">
          Yes. Run <code>npx @q8idevai/hub</code> and complete setup in the browser. The source is
          available on{" "}
          <a href="https://github.com/Q8iDevAI/hub" className={LINK_CLASS}>
            GitHub
          </a>
          , and the{" "}
        ...
        <FAQItem question="What do I need to run it?">
          Node.js and a running Q8iDevAI daemon. Hub guides you through connecting the provider apps
          you want.
        </FAQItem>
        ...
        <FAQItem question="Do I have to move my team to a new tool?">
          ...
          already run. When the work gets serious you switch to the Q8iDevAI app on those same daemons.
        </FAQItem>
