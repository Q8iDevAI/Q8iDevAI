...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Q8iDevAI" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://q8idevai.sh/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://q8idevai.sh/og-image.png" },
    ],
    links: [
