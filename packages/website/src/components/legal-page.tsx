...
export function Q8iDevAILegalIdentity() {
  return (
    <address className="not-italic">
      <strong className="font-medium text-white">MOHAMMAD MOFTAH</strong>, operating as Q8iDevAI
      <br />
      ...
      <br />
      Email: <a href="mailto:Admin@Q8iDev.CoM">Admin@Q8iDev.CoM</a>
    </address>
  );
}
