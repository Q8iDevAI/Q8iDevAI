...
import { LetterTile, Q8iDevAITile } from "./atoms";
 ...
 * an optional running dot. Uses Q8iDevAITile so pinned and workspace icons match. */
function WorkspaceGlyph({ running, white }: { running?: boolean; white?: boolean }) {
  return (
    <span className="relative flex size-[18px] items-center justify-center">
      {white ? <span className="size-[18px] rounded-[5px] bg-mock-fg" /> : <Q8iDevAITile />}
      {running ? (
...
const READY: RowData[] = [
  {
    key: "q8idevai-homepage",
    icon: <WorkspaceGlyph />,
    title: "Q8iDevAI homepage",
    time: "now",
    pr: "3981",
    passed: true,
    selected: true,
