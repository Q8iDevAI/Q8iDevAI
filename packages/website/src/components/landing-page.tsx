...
const SOCIAL_PROOF_TWEETS = [
  ...
  },
  {
    ...
    text: "Q8iDevAI is a really good interface for Pi. It’s not the only thing it does, but that’s my current use case for now.",
  },
  {
    name: "Dong",
    handle: "@dongnaebi",
    ...
    text: "Q8iDevAI is the best software I've used this year. Absolutely amazing!",
  },
] as const;
  ...
  return (
    ...
    >
      <SectionTitle
        ...
        description="See what developers are saying about Q8iDevAI"
      />
...
function TurnkeySection() {
  return (
    <FeatureSection
      ...
      description="Use Q8iDevAI locally, from another machine, or with a team"
    >
        ...
        <div className="p-6 md:p-8">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <TurnkeyExtensionCard
              ...
              description="Run Q8iDevAI on a home lab, or a cloud machine"
...
function AutomationSection() {
  ...
  return (
    <FeatureSection
      ...
      description="Use MCP, the CLI, or the TypeScript SDK to automate Q8iDevAI"
  ...
  return (
    <div className="font-mono text-[11px] leading-5 text-white/60">
      <div className="space-y-6">
        <div>
          <ShellPrompt>
            <span className="text-white">q8idevai run</span> <span className="text-white/35">\</span>
          </ShellPrompt>
          <div className="pl-5">
        ...
        <div className="space-y-1">
          <ShellPrompt>
            <span className="text-white">q8idevai ls</span>
          </ShellPrompt>
          <AgentListOutput />
        </div>
...
function SdkAutomationExample() {
  return (
    <pre className="overflow-x-auto font-mono text-[11px] leading-5 text-white/60">
      <span className="text-purple-300">import</span> {"{"} createQ8iDevAIClient {"}"}{" "}
      <span className="text-purple-300">from</span>{" "}
      <span className="text-emerald-300/80">{'"@q8idevai/client"'}</span>;{"\n\n"}
      <span className="text-purple-300">const</span> client ={" "}
      <span className="text-sky-300">createQ8iDevAIClient</span>({"{"}
      ...
      <span className="text-emerald-300/80">{'"/Users/me/dev/q8idevai"'}</span>,{"\n"} prompt:{" "}
...
function ExtensibleSection() {
  return (
    <FeatureSection title="Make it yours" description="Extend Q8iDevAI to work just the way you want">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <ExtensibleCard
          icon={GitFork}
          title="Fork the repo"
          description="Q8iDevAI is licensed under Apache 2.0. You can inspect the implementation, fork the project, and adapt it to your workflow or organization"
...
const FORK_CARD_LINKS: ReadonlyArray<ExtensibleCardLink> = [
  {
    href: "https://github.com/Q8iDevAI/Q8iDevAI",
...
const SERVER_INSTALL_FOOTNOTE = (
  <>
    Requires Node.js 18+. Run <span className="font-mono text-white/40">q8idevai</span> to start the
    daemon.
  </>
);
...
function ServerInstallButton() {
  return (
    <CommandDialog
      ...
      description="For headless machines you want to connect to from the Q8iDevAI apps. The desktop app already includes a built-in daemon"
      command="npm install -g @q8idevai/cli && q8idevai"
    ...
    <div ref={containerRef} className="flex flex-col items-center pt-4 pb-16 gap-20">
      ...
      >
        ...
        <motion.div
          ...
          role="img"
          aria-label="Q8iDevAI workspace drawer"
        >
        ...
        <motion.div
          ...
          role="img"
          aria-label="Q8iDevAI agent chat"
        >
    ...
    >
      ...
      <div className="space-y-6">
        <FAQItem question="Is this free?">
          Yes. Q8iDevAI is free and open source. You need agent providers installed with your own
        ...
        <FAQItem question="Does my code leave my machine?">
          Q8iDevAI doesn&apos;t send your code anywhere. Agents run locally and talk to their own APIs
        ...
        <FAQItem question="What agents does it support?">
          Q8iDevAI supports many providers. It has custom implementations for Claude, Codex, OpenCode,
        ...
        <FAQItem question="How does Q8iDevAI run providers?">
          Q8iDevAI runs the providers installed on your machine as you&apos;d normally run them. Q8iDevAI
        ...
        <FAQItem question="Can I connect from outside my network?">
          Yes. You can use the hosted relay (end-to-end encrypted, Q8iDevAI can&apos;t read your
        ...
        <FAQItem question="Do I need git or GitHub?">
          No. Q8iDevAI works in any directory. Worktrees are optional and only relevant if you use git.
          You can run agents anywhere you&apos;d normally work.
        </FAQItem>
        <FAQItem question="Can I get banned for using Q8iDevAI?">
          Q8iDevAI is designed to use each provider&apos;s officially supported integration and does
        ...
        <FAQItem question="How do worktrees work?">
          When you launch an agent with the worktree option (from the app, desktop, or CLI), Q8iDevAI
  ...
  return (
    ...
    >
      <div className="text-sm text-muted-foreground leading-relaxed space-y-3">
        <p>Q8iDevAI is an independent open source project for running coding agents.</p>
        ...
        <p>I am hoping that you will enjoy Q8iDevAI as much as I do.</p>
        <p>If you like Q8iDevAI, sponsorship is the best way to support continued development.</p>
        <p>- Mo</p>
      </div>
      <div className="pt-2">
        <a
