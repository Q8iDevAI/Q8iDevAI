...
export function releaseBase(version: string) {
  return `https://github.com/Q8iDevAI/Q8iDevAI/releases/download/v${version}`;
}
...
export function downloadUrls(release: ReleaseAssetInfo) {
  ...
  return {
    macAppleSilicon: `${base}/Q8iDevAI-${version}-arm64.dmg`,
    macIntel: `${base}/Q8iDevAI-${version}-x64.dmg`,
    linuxAppImage: `${base}/${linuxAppImageAsset}`,
    linuxDeb: `${base}/Q8iDevAI-${version}-amd64.deb`,
    linuxRpm: `${base}/Q8iDevAI-${version}-x86_64.rpm`,
    windowsExeX64: `${base}/${windowsX64Asset ?? `Q8iDevAI-Setup-${version}.exe`}`,
    windowsExeArm64: windowsArm64Asset ? `${base}/${windowsArm64Asset}` : null,
    androidApk: `${base}/q8idevai-v${version}-android.apk`,
  };
}

export const appStoreUrl = "https://apps.apple.com/app/q8idevai-pocket-engineer/id6758887924";
export const playStoreUrl = "https://play.google.com/store/apps/details?id=sh.q8idevai";
export const webAppUrl = "https://app.q8idevai.sh";
