...
```bash
q8idevai plugin add /absolute/path/to/q8idevai/plugin-examples/linear
q8idevai plugin ls linear
```

Use `q8idevai plugin reload linear` after source edits. Changing the API key requires restarting the
