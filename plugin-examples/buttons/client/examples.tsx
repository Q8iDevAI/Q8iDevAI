...
export function createButtonExamples(
  ...
  async function refreshWorkspace() {
    // Return the real operation's promise: Q8iDevAI supplies pending, double-press prevention, and errors.
    await client.q8idevai.workspaces.ref(workspaceId).refresh();
    refreshes += 1;
    if (mode === "action") {
