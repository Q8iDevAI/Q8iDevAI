...
Q8iDevAI is minimal, spacious, quiet, confident. Whitespace is deliberate. Nothing crowds, nothing decorates, nothing apologizes. A row, a label, a control. That is the bar.
...
Sentence case. "Pair a device", "Danger zone", "Restart daemon", "Inject Q8iDevAI tools", "No sessions yet", "Load more". Proper nouns retain casing — Q8iDevAI, Beta, Stable, Local. Title case is wrong.
