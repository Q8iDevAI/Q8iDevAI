# Adding a Git Forge to Q8iDevAI

Q8iDevAI's forge layer is a registry/manifest system. A forge is a runtime concern:
...
allowlist. Self-hosted detection is a trust gate: Q8iDevAI only talks to a forge
